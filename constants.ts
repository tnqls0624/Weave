...
export const USERS: User[] = [
  ...
  },
  {
    ...
    color: "emerald",
    initialLocation: { latitude: 37.7759, longitude: -122.4224 },
  },
  {
    id: "user3",
    name: "Sam",
    ...
    color: "orange",
    initialLocation: { latitude: 37.7719, longitude: -122.4154 },
  },
  {
    id: "user4",
    name: "Jess",
    ...
    color: "violet",
    initialLocation: { latitude: 37.7789, longitude: -122.4184 },
  },
];
...
export const EVENTS: Event[] = [
  ...
  },
  {
    ...
    startDate: dayjs(dayAfterTomorrow).format("YYYY-MM-DD"),
    startTime: "11:00",
    endTime: "11:30",
  },
  {
  ...
  },
  {
    ...
    title: "Business Trip",
    startDate: dayjs(fourDaysFromNow).format("YYYY-MM-DD"),
    endDate: dayjs(sixDaysFromNow).format("YYYY-MM-DD"),
    startTime: "08:00",
    endTime: "17:00",
